...
export default function FormEnviarEmail() {
  ...
  return (<div className={styles.componentEmail}>
    <p>Assine a NewsLetter para receber as novidades</p>
    <form className={styles.formEnviarEmail}
    onSubmit={(evento) => {
      ...
      <div >
        <label>
          <h2 className={styles.formEnviarEmail}>
            Email
            </h2>
          <input className={styles.formEnviarInput}
            name="email"
            type="email"
